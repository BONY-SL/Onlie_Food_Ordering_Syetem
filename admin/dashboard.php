                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="card p-30">
                            <div class="media">
                                <div class="media-left meida media-middle"> 
                                    <span><img src="images/OIP.jpg" style="width:65px;height:65px;"></span>
                                </div>
                                <div class="media-body media-text-right">
                                    <h2><?php 
                                        $result = mysqli_query($db, 'SELECT SUM(price*quantity) AS value_sum FROM users_orders WHERE status = "closed"'); 
