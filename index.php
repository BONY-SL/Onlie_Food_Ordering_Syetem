...
<body class="home">
        ...
        <header id="header" class="header-scroll top-header headrom">
            <nav class="navbar navbar-dark">
                <div class="container">//comment
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/thuan_paha_intro.png" alt=""> </a>
        ...
        <section class="hero bg-image" data-image-src="images/img/rest.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1 style="margin-top:150px;">FOOD FAST DELIVERY OR TAKE OUT</h1>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>Popular 6 Dishes of the Month</h2>
                    <p class="lead">Order your favorite food from these cuisines</p>
                </div>
                <div class="row">
						<?php 					
                ...
                <div class="bottom-footer">
                    <div class="row">
                        <div class="col-xs-12 col-sm-3 payment-options color-gray">
                            ...
                            <ul>
                                        <li>
                                            <a href="restaurants.php"> <img src="images/R.jpg" alt="Paypal" style="width:250px;height:80px;"> </a>
                                        </li>
                            </ul>
                        </div>
